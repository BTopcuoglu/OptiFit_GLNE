...
2.  OptiFit Greengenes: Reference sequences from the Greengenes database
    ...
    novel OTUs from the test set were removed. The data set was then
...
3.  VSEARCH Greengenes: Preprocessed data was clustered using VSEARCH
    ...
    test set were removed. The data set was then split into two sets
...
**Figure 2: Model perfomance of OptiFit self-reference workflow is as
