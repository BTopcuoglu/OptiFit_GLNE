# copied from https://github.com/SchlossLab/Sovacool_OptiFit_mSphere_2022/blob/main/code/R/gg_tax.R
# adapted from https://mothur.org/blog/2014/greengenes-v13_8_99-reference-files/

tax <- scan(file = "data/references/tmp/gg_13_8_99.gg.tax", sep = "\t", what = "", quiet = T)
nlines <- length(tax)
...
write.table(updated.tax, file = "data/references/tmp/gg.tax", row.names = F, col.names = F, quote = F, sep = "\t")